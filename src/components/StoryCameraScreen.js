    ...
    <View style={{ flex: 1 }}>
      ...
      {imageUri ? (
        <View style={{ flex: 1 }}>
          ...
          <TouchableOpacity onPress={() => setImageUri(null)} style={{ position: 'absolute', bottom: 60, alignSelf: 'flex-start' }}>
      ...
      {imageUri && (
        <TouchableOpacity onPress={saveToGallery} style={{ position: 'absolute', bottom: 60, alignSelf: 'flex-end' }}>
